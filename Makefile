...
gen-openapi: ## generates openapi documentation under /docs folder
	swag init -d cmd/server/,internal/healthcheck/,internal/auth,internal/connection,internal/fact,internal/message,internal/entity,internal/request,internal/app